                    ...
                    if (!controller.isCodeSent)
                      ...
                      Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            _buildInputLabel("Driver Identity"),
                            ...
                            _buildTextField(_phoneController, "Phone Number",
                                ...
                                hint: "07... or 01..."),
                            const SizedBox(height: 20),
                            _buildInputLabel("Vehicle Registry"),
                            DropdownButtonFormField<String>(
                              value: _selectedVehicle,
                              decoration: _inputDecoration(
                                  "Service Tier", LucideIcons.car),
                              dropdownColor: Theme.of(context).canvasColor,
                              items: const [
                                DropdownMenuItem(
                                    value: "tulia",
                                    child: Text("Tulia (Economy)")),
                                DropdownMenuItem(
                                    value: "nuru",
                                    child: Text("Nuru (Comfort)")),
                                DropdownMenuItem(
                                    value: "pamoja",
                                    child: Text("Pamoja (XL)")),
                                DropdownMenuItem(
                                    value: "waziri",
                                    child: Text("Waziri (Exec)")),
                              ],
                              onChanged: (val) =>
                            ...
                            _buildTextField(_plateController,
                                "Vehicle Number Plate", LucideIcons.hash),
                            const SizedBox(height: 20),
                            ElevatedButton(
                              onPressed: controller.isLoading
                                  ...
                                  : () async {
                                      if (_phoneFormKey.currentState!
                                          .validate()) {
                                        // Map local state to controller before sending OTP
                                        controller.name =
